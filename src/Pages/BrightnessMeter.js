...
class BrightnessMeter extends  Component{
  constructor(props){
    super(props)
    this.state={
      devicesActive:1,
      ...
      <div className={classes.root}>
        ...
        <Grid xs={12} md={7} lg={7} className={classes.devices} justifyContent="center">
          <div className={classes.fontrealtime}>
              ...
              borderBottom:'1px solid #B0BBB6', padding:'10px'}}
               to='/brightness-meter'>Brighness Meter-Location:Office, Navy Mumbai</NavLink>
          </div>
        </Grid>
        <Grid item xs={12} md={5} lg={5} className={classes.devices}>
         ...
         <Grid item xs={12}>
          ...
          <Grid item xs={7} lg={3} sm={4} className={classes.curbrightness}>
          <Typography className={classes.parametrs} >
              Current Brightness
            </Typography>
            <Typography className={classes.data} >
              {curbri} <span style={{fontSize:'15px'}}>Lux</span>
            </Typography>
          </Grid>
          <Grid item xs={5} lg={2} sm={4}>
          <Typography className={classes.parametrs} >
              Max Level Today
            </Typography>
            <Typography className={classes.data}  >
              {maxbri} <span style={{fontSize:'15px'}}>Lux</span>
            </Typography>
          </Grid>
          <Grid item xs={6} lg={2} sm={4} className={classes.minleveltoday}>
          <Typography className={classes.parametrs} >
              Min Level Today
            </Typography>
            <Typography className={classes.data} >
              {minbri} <span style={{fontSize:'15px'}}>lux</span>
            </Typography>
          </Grid>
          <Grid xs={7} lg={2} sm={6}></Grid>
         
         <Grid container item xs={12}>
         <Grid item xs={12} lg={6} sm={6} className={classes.graph}>
          <LineChart
      width={380}
      height={285}
      data={data}
...
export default withStyles(styles)(BrightnessMeter);