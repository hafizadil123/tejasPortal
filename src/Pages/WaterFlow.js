      ...
      <div className={classes.root}>
        ...
        <Grid xs={12} md={7} lg={7} className={classes.devices} justifyContent="center">
          <div className={classes.fontrealtime}>
              ...
              borderBottom:'1px solid #B0BBB6', padding:'10px'}}
               to='/water-flow'>water Flow And Level-Location:Office, Navy Mumbai</NavLink>
          </div>
        </Grid>
        <Grid item xs={12} md={5} lg={5} className={classes.devices}>
         ...
         <Grid item xs={12}>
          ...
          <Grid item xs={6} lg={2} sm={3} className={classes.currentwtr}>
          ...
          {/* <Grid item xs={12} lg={3} md={12}></Grid> */}
          {/* bottom */}
          <Grid item xs={6} lg={2} sm={3} className={classes.currentwtrflow}>
          <Typography className={classes.parametrs} >
              Current Water Flow
            </Typography>
            <Typography className={classes.data}>
            {curwtrflow} <span style={{fontSize:'15px'}}>ltr/m</span>
            </Typography>
          </Grid>
          <Grid item xs={6} lg={2} sm={3}>
          <Typography className={classes.parametrs}>
            ...
            <Typography className={classes.data}>
              {todaywtrflow} <span style={{fontSize:'15px'}}>ltrs</span>
            </Typography>
          </Grid>
          <Grid item xs={6} lg={2} sm={3} className={classes.wtrweek}>
          <Typography className={classes.parametrs}>
              Water Flow This Week
            </Typography>
            <Typography className={classes.data}>
              {weeklywtrflow} <span style={{fontSize:'15px'}}>ltrs</span>
            </Typography>
          </Grid>
          <Grid item xs={6} lg={2} sm={3} className={classes.wtrflowthismonth}>
          <Typography className={classes.parametrs}>
              Water Flow This Month
            </Typography>
            <Typography className={classes.data}>
              {monthlywtrflow} <span style={{fontSize:'15px'}}>ltrs</span>
            </Typography>
          </Grid>
...
export default withStyles(styles)(WaterFlow);